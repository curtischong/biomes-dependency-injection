...
export class NodeMap {
    private readonly contents = new Map<string | number, NodeMap | Node<unknown>>();
    public size = 0;
    ...
    *[Symbol.iterator](base: Arg[] = []): IterableIterator<[Arg[], Node<unknown>]> {
...
export class Resources {
    ...
    set<T extends {}>(path: string, ...args: [...Arg[], Exclude<T, any[]>]): void {
